...
PYTHON_BIN="${PYTHON_BIN:-/mnt/public/zhangjiahao2/openpi/.venv/bin/python}"
CONFIG_NAME="${CONFIG_NAME:-x2robot_s2m_sft_openpi}"

export EMBODIED_PATH="${SCRIPT_DIR}"
export HF_LEROBOT_HOME="${HF_LEROBOT_HOME:-/mnt/public/songsiqi/data/lerobot}"
export PYTHONPATH="${REPO_PATH}:/mnt/public/zhangjiahao2/openpi/src:${PYTHONPATH:-}"
